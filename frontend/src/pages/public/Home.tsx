                    ...
                    <div className="w-full max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12">
                        <div className="lg:col-span-8 space-y-8 relative z-10">
                            ...
                            <div className="flex flex-wrap gap-6 pt-8">
                                <Link to={HERO_SLIDES[currentSlide].link} className="px-10 py-5 bg-white text-slate-950 rounded-full font-black text-sm uppercase tracking-widest hover:bg-slate-900 hover:text-white transition-all transform hover:scale-105 shadow-xl shadow-white/10 flex items-center gap-3">
                                    {HERO_SLIDES[currentSlide].cta} <ArrowRight size={18} />
                                </Link>
                                <button className="px-10 py-5 bg-white/5 border border-white/10 text-white rounded-full font-black text-sm uppercase tracking-widest hover:bg-white/10 transition-all backdrop-blur-sm flex items-center gap-3">
                                ...
                                <div className="flex flex-col md:flex-row md:items-center justify-between w-full">
                                    ...
                                    <div className="flex-1 max-w-md relative">
                                        <input
                                            ...
                                            className="w-full px-6 py-4 bg-slate-50 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-indigo-600/10 outline-none transition-all font-bold text-sm text-slate-900 placeholder:text-slate-400"
                                        />
                                        <button className="absolute right-2 top-2 bottom-2 px-6 bg-slate-900 text-white rounded-xl font-black text-xs uppercase tracking-widest hover:bg-slate-800 transition-all active:scale-95">
                                            查詢
                                        </button>
                                    </div>
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                                ...
                                <Link to="/reports" className="group relative aspect-square rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                                    ...
                                    <div className="absolute bottom-8 left-8 right-8">
                                        ...
                                        <p className="text-slate-300 text-xs font-medium opacity-80 mb-6">獲取透明、開源的動保數據</p>
                                        <div className="flex items-center gap-2 text-white font-black text-xs uppercase tracking-widest group-hover:translate-x-2 transition-transform">
                                            立即下載 <Download size={16} />
                                        </div>
                                    </div>
                                </Link>
                                ...
                                <Link to="/academy" className="group relative aspect-square rounded-[2rem] overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2">
                                    ...
                                    <div className="absolute bottom-8 left-8 right-8">
                                        ...
                                        <p className="text-slate-200 text-xs font-medium opacity-80 mb-6">專業人員教育訓練與資源庫</p>
                                        <div className="flex items-center gap-2 text-white font-black text-xs uppercase tracking-widest group-hover:translate-x-2 transition-transform">
                                            進入學院 <ArrowRight size={16} />
                                        </div>
                                    </div>
                                </Link>
                            </div>
                        ...
                        <div className="md:w-1/3 bg-slate-950 p-10 md:p-14 text-white flex flex-col justify-between relative overflow-hidden group">
                            <div className="relative z-10">
                                <div className="mb-10">
                                    ...
                                    <p className="text-slate-400 text-xs font-bold tracking-widest uppercase">百科全書 • FAQ</p>
                                </div>
                                ...
                                <div className="space-y-4 mb-10">
                                    {[
                                        ...
                                        <div key={i} className="group/item flex items-center justify-between p-5 bg-white/5 border border-white/5 rounded-2xl hover:bg-white/10 transition-all cursor-pointer">
                                            <span className="text-sm font-bold text-slate-300 group-hover/item:text-white transition-colors">{q}</span>
