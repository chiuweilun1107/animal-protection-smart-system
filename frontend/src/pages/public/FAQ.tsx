        ...
        <div className="min-h-screen bg-slate-50 pb-40">
            <div className="max-w-7xl mx-auto px-6">
                <PageHeader
                    ...
                    title="服務百科"
                    subtitle="常見問題"
                    description="為了提供更高效的服務，我們整理了關於動保通報、救傷基準以及後續處理流程的常見疑問。您可以透過關鍵字快速檢索您需要的解答。"
                >
                    <div className="w-full lg:w-96">
                        <div className="relative group">
                            <input
                                ...
                                className="w-full px-8 py-5 bg-white border-2 border-slate-200 rounded-[2rem] text-slate-900 focus:ring-4 focus:ring-blue-600/10 focus:border-blue-600 outline-none transition-all font-bold placeholder:text-slate-300 shadow-sm"
                            />
                        </div>
                    </div>
                </PageHeader>
                ...
                <div className="flex flex-wrap gap-4 mb-16">
                    <button
                        ...
                        className={`px-8 py-3 rounded-2xl font-black text-base uppercase tracking-widest transition-all ${activeSection === 'all'
                    ...
                    {FAQ_SECTIONS.map(s => (
                        <button
                            ...
                            className={`px-8 py-3 rounded-2xl font-black text-base uppercase tracking-widest transition-all ${activeSection === s.id
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16">
                                        ...
                                        return (
                                            <div key={qIdx} className={`group relative bg-white rounded-[2.5rem] border transition-all duration-500 overflow-hidden ${isOpen ? 'border-blue-500 shadow-2xl shadow-blue-500/10 ring-1 ring-blue-400/20' : 'border-slate-100 hover:border-blue-200'}`}>
                                                ...
                                                >
                                                    ...
                                                    <div className={`shrink-0 font-black text-base transition-all duration-500 ${isOpen ? 'text-blue-600' : 'text-slate-300'}`}>
                                                        {isOpen ? 'CLOSE' : 'OPEN'}
                                                    </div>
                                                </button>
                                                <div className={`transition-all duration-500 ${isOpen ? 'max-h-[1000px] opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
                                                    <div className="px-10 pb-12 text-slate-600 font-medium leading-relaxed bg-slate-50/50 pt-6">
                                                        <div className="p-8 bg-white border border-slate-100 rounded-[2rem] shadow-inner text-xl leading-relaxed">
                                                            {q.a}
                                                        </div>
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        ...
                        <div className="bg-white rounded-[3rem] border border-slate-100 shadow-xl p-10">
                            <h3 className="text-base font-black text-slate-900 uppercase tracking-[0.2em] mb-8">
                                快速鏈結
                            </h3>
